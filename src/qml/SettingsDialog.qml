...
Dialog {
    ...
    property var setShortcutForCommand: null
    property var clearShortcutOverride: null
    property var resetAllShortcuts: null
    ...
    contentItem: ColumnLayout {
        ...
        TabBar {
            ...
            TabButton {
                ...
                font.pixelSize: 11; font.bold: true
                contentItem: Text {
                    text: hotkeysTab.text
                    color: hotkeysTab.checked ? theme.accent : theme.textSecondary
                    horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter
                }
                background: Rectangle {
                    color: "transparent"
                    Rectangle { anchors.bottom: parent.bottom; width: parent.width; height: 2; color: theme.accent; visible: hotkeysTab.checked }
                }
            }
        }
            ...
            Item {
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            Layout.fillWidth: true
                            text: "Customize shortcuts. Leave empty to disable a shortcut."
                        ...
                        Button {
                            ...
                            onClicked: {
                                if (typeof resetAllShortcuts === "function") resetAllShortcuts()
                            }
                        }
                    }
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                ColumnLayout {
                                    Layout.fillWidth: true
                                    spacing: 2
                                    Text { text: modelData.label; color: theme.textPrimary; font.pixelSize: 12; font.bold: true; elide: Text.ElideRight; Layout.fillWidth: true }
                                    Text {
                                        text: modelData.category + " • Default: " + (modelData.defaultShortcut && modelData.defaultShortcut.length > 0 ? modelData.defaultShortcut : "None")
                                ...
                                TextField {
                                    ...
                                    placeholderText: "e.g. Ctrl+Shift+M"
                                ...
                                Button {
                                    text: "Save"
                                    onClicked: {
                                        if (typeof setShortcutForCommand === "function") {
                                            const ok = setShortcutForCommand(modelData.id, shortcutField.text)
                                            if (!ok) shortcutField.forceActiveFocus()
                                        }
                                    }
                                }
                                ...
                                Button {
                                    text: "Clear"
                                    onClicked: {
                                        if (typeof setShortcutForCommand === "function") setShortcutForCommand(modelData.id, "")
                                    }
                                }
                                ...
                                Button {
                                    text: "Reset"
                                    onClicked: {
                                        if (typeof clearShortcutOverride === "function") clearShortcutOverride(modelData.id)
                                    }
                                }
                            }
                        }
