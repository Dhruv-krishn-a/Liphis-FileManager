...
Item {
    ...
    Menu {
        ...
        Material.background: theme ? theme.surfaceElevated : "#2A2A2A"
    ...
    Component {
        ...
        Item {
            ...
            RowLayout {
                ...
                FileIcon { Layout.preferredWidth: 22; Layout.preferredHeight: 22; isDir: model.isDir }
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    FileIcon { anchors.centerIn: parent; width: 56; height: 56; isDir: model.isDir; visible: !gridThumb.visible }
                    Image { 
